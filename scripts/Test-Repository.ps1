...
$coreRequired = @(
    ...
    'contracts/workflow-validation-result.schema.json',
    ...
    'reference/workflow_service.py',
    'tests/reference/test_workflow_registry.py',
    'tests/reference/test_workflow_service.py',
    ...
    'contracts/fixtures/workflow-validation-result.valid.json',
